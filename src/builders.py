...
def criar_conjuntos_de_dados_para_treino(posicao,atividade,magacc,xacc,yacc,zacc,maggir,xgir,ygir,zgir):
    ...
    rotulo_multiplos ,rotulo_tres,rotulo_binario1,rotulo_binario2 = create_labels(atividade)
    ...
    if len(xgir) >= tamanho_do_array and len(xacc) >= tamanho_do_array:
        if atividade in lista_atividades_de_cinco_segundos:
            ...
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, magacc, tamanho_do_array, lista_array_de_dados_magacc, lista_array_de_dados_magacc_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, "sim_acc")
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, xacc, tamanho_do_array, lista_array_de_dados_xacc, lista_array_de_dados_xacc_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2)
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, yacc, tamanho_do_array, lista_array_de_dados_yacc, lista_array_de_dados_yacc_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2)
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, zacc, tamanho_do_array, lista_array_de_dados_zacc, lista_array_de_dados_zacc_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2)
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, maggir, tamanho_do_array, lista_array_de_dados_maggir, lista_array_de_dados_maggir_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, "sim_gir")
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, xgir, tamanho_do_array, lista_array_de_dados_xgir, lista_array_de_dados_xgir_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2)
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, ygir, tamanho_do_array, lista_array_de_dados_ygir, lista_array_de_dados_ygir_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2)
            generate_array_of_activities_lasting_5seconds(valor_maximo_acc, atividade, zgir, tamanho_do_array, lista_array_de_dados_zgir, lista_array_de_dados_zgir_transformada, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2)

        elif atividade in lista_atividades_de_transicao:
            generate_array_of_transition_activities(magacc, tamanho_do_array, lista_array_de_dados_magacc, lista_array_de_dados_magacc_transformada)

            generate_array_of_transition_activities(xacc, tamanho_do_array, lista_array_de_dados_xacc, lista_array_de_dados_xacc_transformada)
            generate_array_of_transition_activities(yacc, tamanho_do_array, lista_array_de_dados_yacc, lista_array_de_dados_yacc_transformada)
            ...
            multiple_class_label_list_time_domain.append(rotulo_multiplos)
            ...
            multiple_class_label_list_frequency_domain.append(rotulo_multiplos)
            ...
            generate_array_of_other_activities(magacc, tamanho_do_array, lista_array_de_dados_magacc, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_magacc_transformada, "sim_acc")
            generate_array_of_other_activities(xacc, tamanho_do_array, lista_array_de_dados_xacc, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_xacc_transformada)
            generate_array_of_other_activities(yacc, tamanho_do_array, lista_array_de_dados_yacc, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_yacc_transformada)
            generate_array_of_other_activities(zacc, tamanho_do_array, lista_array_de_dados_zacc, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_zacc_transformada)
            generate_array_of_other_activities(maggir, tamanho_do_array, lista_array_de_dados_maggir, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_maggir_transformada, "sim_gir")
            generate_array_of_other_activities(xgir, tamanho_do_array, lista_array_de_dados_xgir, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_xgir_transformada)
            generate_array_of_other_activities(ygir, tamanho_do_array, lista_array_de_dados_ygir, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_ygir_transformada)
            generate_array_of_other_activities(zgir, tamanho_do_array, lista_array_de_dados_zgir, rotulo_multiplos, rotulo_tres, rotulo_binario1, rotulo_binario2, lista_array_de_dados_zgir_transformada)
...
for subdiretorio in lista_de_subdiretorios:
    acc,gir,sampling = get_file_path(diretorio_principal, subdiretorio, posicao)
