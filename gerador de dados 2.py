...
diretorio1 = "/home/dev/Área de trabalho/Combatente/Conjuntos/Tempo/0/Treino/0"
diretorio2 = "/home/dev/Área de trabalho/Combatente/Conjuntos/Tempo/0/Treino/1"
diretorio3 = "/home/dev/Área de trabalho/Combatente/Conjuntos/Freq/0/Teste/0"
diretorio4 = "/home/dev/Área de trabalho/Combatente/Conjuntos/Freq/0/Teste/1"
#diretorio5 = "/home/dev/PycharmProjects/FallDetection/conv/mobiact"
...
for arquivo in lista_arquivos:
    ...
    if os.path.exists(caminho_arquivo):
        if arquivo in os.listdir('/home/dev/PycharmProjects/FallDetection/conv/dados/queda'):
            criar_array_queda(gerar_df(arquivo),0,diretorio1)
            criar_array_queda_transformada(gerar_df(arquivo),diretorio3)

        else:
            criar_array_adl(gerar_df(arquivo),1,diretorio2)
            criar_array_adl_transfomada(gerar_df(arquivo),diretorio4)
