import csv
import os
from model_builders import generate_training_testing_and_validation_sets, create_study_object, objective, \
...
#label_type = "multiple"
#label_type = "three_labels"
#label_type = "binary_one"
label_type = "binary_two"

data_path = "../labels_and_data/data/chest" if position == "chest" else "../labels_and_data/data/left" if position == "left" else "../labels_and_data/data/right"
label_path = "../labels_and_data/labels/chest" if position == "chest" else "../labels_and_data/labels//left" if position == "left" else "../labels_and_data/labels/right"
...
label_index = 1 if label_type == "multiple" else 2 if label_type == "three_labels" else 3 if label_type == "binary_one" else 4
label_options = {1:"multiple_class_label.npy",2:"three_class_label.npy",3:"binary_class_label_1.npy",4:"binary_class_label_2.npy"}
...
if neural_network_type == "CNN1D":
    ...
    scenario_dir = os.path.join(os.path.join(neural_network_results_dir, scenario))
...
for i in range(1, 4):
    if neural_network_type == "CNN1D":
        ...
        save_results(model, historic, X_test, y_test, 2, i, decision_threshold, mlp_output_dir,neural_network_type)
